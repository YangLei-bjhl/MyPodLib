...
// MyPodLib
#define COCOAPODS_POD_AVAILABLE_MyPodLib
#define COCOAPODS_VERSION_MAJOR_MyPodLib 0
#define COCOAPODS_VERSION_MINOR_MyPodLib 1
#define COCOAPODS_VERSION_PATCH_MyPodLib 0
